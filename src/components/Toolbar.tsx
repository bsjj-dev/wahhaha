...
export default function Toolbar({
  ...
  return (
    <div className="absolute bottom-[max(1rem,env(safe-area-inset-bottom))] left-1/2 -translate-x-1/2 flex items-center gap-2 bg-[var(--wah-dark)]/90 border border-[var(--wah-wood)] rounded-full px-4 py-2 backdrop-blur-sm">
      <button
        onClick={onToggleMic}
